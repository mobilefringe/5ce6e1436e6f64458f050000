<template>
    <div class="inside_header_background" v-if="pageBanner" :style="{ background: 'linear-gradient(0deg, rgba(174, 13, 41, 0.8), rgba(174, 13, 41, 0.8)), url(' + pageBanner.image_url + ') center center no-repeat rgba(174, 13, 41)' }">
